...
print('Naive loss vs analytical')
...
print('Vector loss vs analytical')
...
lr = [1e-7, 5e-7, 1e-6, 5e-6, 1e-4, 5e-4]
reg = [2.5e4, 5e4]
num_iters = 3000
best_softmax, results, all_classifiers = softmax_hyperparameter_tuning(X_train, y_train, X_val, y_val, lr, reg, num_iters)
